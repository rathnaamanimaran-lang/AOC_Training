CLASS zcl_rath_data_uplaoder DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
METHOD fill_master_data.
    data : lt_bp type table of zrath_bpa,
           lt_prod type table of zrath_product.
   ...
   append value #(
    ...
    append value #(
     ...
     insert zrath_bpa from table @lt_bp.
  ...
  METHOD fill_transaction_data.
    data : o_rand type REF TO cl_abap_random_int,
           ...
           lv_ord_id type zrath_dte_id,
           lt_so type table of zrath_so_hdr,
           lt_so_i type table of zrath_so_item.
    ...
    select * from zrath_bpa into table @data(lt_bpa).
    select * from zrath_product into table @data(lt_prod).
    ...
    insert zrath_so_hdr from table @lt_so.
